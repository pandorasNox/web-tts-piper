  ...
  return (
    <>
      ...
      <div className="text-center">
        <button className="p-2 bg-gray-500 rounded-full hover:bg-gray-400 focus:outline-none focus:ring-4 focus:ring-blue-700 cursor-pointer"
            onClick={() => setShowSettingsState(!showSettingsState)}
          >
